            ...
            <p className="flex items-center space-x-2 mt-10">
              ...
              <div className="pt-4">
                ...
                <div className="flex space-x-6 text-cyan-400">
                  ...
                  <a
                    href="https://www.instagram.com/sanjay.kalpana237?igsh=dXdqdWxsM2pldWJ3"
                    target="_blank"
                    rel="noopener noreferrer"
